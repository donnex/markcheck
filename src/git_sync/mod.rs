...
use inspect::{
    ...
    commits_ahead_of_upstream, current_head, descends_directly_from, git_dir, hash_object,
    index_blob, index_entry, remote_branch_state, resolve_parent, resolve_upstream, upstream_parts,
};
#[cfg(test)]
mod test_support;
...
#[cfg(test)]
mod tests {
    use super::inspect::current_branch_ref;
