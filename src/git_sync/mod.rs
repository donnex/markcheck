...
use inspect::{
    ...
    commits_ahead_of_upstream, current_branch_ref, current_head, descends_directly_from, git_dir,
    hash_object, index_blob, index_entry, parse_first_parent, remote_branch_state, resolve_parent,
