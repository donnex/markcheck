...
pub struct AppState {
    ...
    pub file_content_hash: Option<u64>,      // hash of the content we last confirmed on disk; guards commit_write against a lost update
